...
//        Connection conn = DriverManager.getConnection("jdbc:derby:test.db;create=true");
        ...
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/"+"Reflection", "root", "");

        PersistenceManager manager = new ReflectivePersistenceManager(conn, Department.class, Person.class);
